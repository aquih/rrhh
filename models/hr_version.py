...
class HrVersion(models.Model):
    ...
    motivo_terminacion = fields.Selection([('reuncia', 'Renuncia'), ('despido', 'Despido'), ('despido_justificado', 'Despido Justificado')], 'Motivo de terminación', groups="hr_payroll.group_hr_payroll_user") # no parece usarse
